 ...
 */
final class Version20240918132535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, gender SMALLINT DEFAULT NULL, embuch_at DATETIME DEFAULT NULL, remuneration INT DEFAULT NULL, status SMALLINT NOT NULL, creat_at DATETIME DEFAULT NULL, last_login_date DATETIME DEFAULT NULL, last_login DATETIME DEFAULT NULL, logout_date DATETIME DEFAULT NULL, is_connect TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
