...
class ProspectType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            // ->add('TeamComrl', Type\ChoiceType::class, [
            //     'mapped' => false,
            //     'label' => 'Équipes et Commerciaux',
            //     'choices' => $this->getTeamsWithComrclsChoices()['choices'],
            //     'choice_attr' => $this->getTeamsWithComrclsChoices()['choice_attr'],
            //     'choice_label' => function ($choice, $key, $value) {
            //         return $choice;
            //     },
            //     'expanded' => false,
            //     'multiple' => false,
            //     'placeholder' => '--Choisissez une équipe et ses commerciaux--',
            // ])
            ->add('team');
        ...
        $formModifier = function (FormInterface $form, Team $team = null) {
            ...
            $comrcl = $team === null ? [] : $this->userRepository->findTeamsWithComrcls();
